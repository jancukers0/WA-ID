...
echo
echo $pur"==================="$cy" ============================="
echo $i"Ôûê"$pu"  AUTHOR  :  Wahyudi ID   "$i"           Ôûê"
echo $i"Ôûê"$pu"  WhatsApp:  083823xxxxx"$i"              Ôûê"
echo $i"Ôûê"$pu"  GMAIL   :  jancuker436@gmail.com"$i"     Ôûê"
echo $i"Ôûê"$pu"  GC     :  TERMUX-ID"$i"    Ôûê"
echo $i"Ôûê"$pu"  YOUTUBE :  sementara kosong cuk..!!"$i"          Ôûê"                                  
echo $pur"==================="$cy" ============================="
echo
...
echo $i"["$me"14"$i"]"$ku" kembali/balik maning cok!!"
echo
echo $pur"Ôò¡ÔöÇ["$pur"Masukkan pilihane cok..!!"$pur"]"
read -p"Ôò¦ÔöÇ>> " pil

if [ $pil = 1 ]
then
clear
figlet -f slant "J N C K"|lolcat
sleep 1
...
then
clear
figlet -f slant "J N C K"|Ulolcat
sleep 2
echo $cy"Terima Kasih sudah mengunakan Tools ini"
sleep 2
echo $i"Silahkan di pakai semoga bermanfaat Buat anda"
sleep 2
echo $pur"Bila Ada Kesalahan Itu salah anda sendiri cokk !!"
sleep 2
echo $ku"Facebook :"$i" -"
echo $ku"YouTube  :"$i" -"
echo $ku"WhatsApp :"$i" 083823xxxxxx"
sleep 2
echo $pur"Terima kasih Yang Sudah Support dengan Tools ini"
sleep 2
echo $pur"kesuwun cuk wis dowload tools kien kuh"
echo $pur"Thanks To Asb,GOC,WCA,MCI"
echo $pur"Spesial Thanks For kamu yang slalu ada di pikiranku"
exit
fi
